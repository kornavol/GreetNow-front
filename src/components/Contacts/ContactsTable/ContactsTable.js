                    ...
                    <thead className="datatable-head">
                        <tr className="datatable-row" style={{ left: 0 }}>
                            ...
                            <th
                                ...
                                style={{ display: "none" }}
                            >
                                <span style={{ width: 108 }}>Company Name</span>
                            </th>
                            <th
                                data-field="Status"
                                className="datatable-cell datatable-cell-sort"
                        ...
                        <tr data-row={0} className="datatable-row" style={{ left: 0 }}>
                            ...
                            <td data-field="Country" aria-label="Brazil" className="datatable-cell">
                                <span style={{ width: 108 }}>
                                    <div className="font-weight-bolder font-size-lg mb-0">Brazil</div>
                            ...
                            >
                                <span style={{ width: 108 }}>
                                    <div className="font-weight-bolder text-primary mb-0">10/15/2017</div>
                            ...
                            >
                                <span style={{ width: 108 }}>
                                    <div className="font-weight-bold text-muted">Casper-Kerluke</div>
                                </span>
                            </td>
                            <td
                                data-field="Status"
